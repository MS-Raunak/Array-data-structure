package _1dArray.SortingAlgorithm;
...
public class SelectionSort {
    ...
    //Selection Sort: Implements the selection sort algorithm by iterating over the array, finding the smallest element, and swapping it with the first unsorted element.
